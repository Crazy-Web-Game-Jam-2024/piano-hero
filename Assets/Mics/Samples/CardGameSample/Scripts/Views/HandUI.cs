    ...
    public class HandUI : MonoBehaviour
    {
        ...
        public async UniTask DiscardCard(Card card)
        {
            ...
            if (success)
            {
                ...
                cardUI.DoLocalRepositioning(new Vector3(0f, 0f, 0f), 0f, 0.1f, playToDiscardRepositionDuration);
                await Task.Delay(TimeSpan.FromSeconds(playToDiscardRepositionDuration));
                discardCount++;
        ...
        public async UniTask PlayCardAnimation(Card card)
        {
            ...
            if (success)
            {
                ...
                RepositionCards();
                cardUI.DoLocalRepositioning(new Vector3(0f, 0f, 0f), 0f, 1f, playFromHandRepositionDuration);
                await Task.Delay(TimeSpan.FromSeconds(playFromHandRepositionDuration));
